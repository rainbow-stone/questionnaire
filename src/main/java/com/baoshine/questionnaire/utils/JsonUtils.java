...
public class JsonUtils {
    ...
    public static <K, V> Map<K, V> toMap(String json, Class<K> keyClass, Class<V> valueClass)
        ...
        return objectMapper
                .readValue(json, TypeFactory.defaultInstance().constructMapType(HashMap.class, keyClass, valueClass));
    }
    ...
    public static <E> List<E> toList(String json, Class<E> elementClass) throws JsonProcessingException {
        return objectMapper
                .readValue(json, TypeFactory.defaultInstance().constructCollectionType(ArrayList.class, elementClass));
    }
