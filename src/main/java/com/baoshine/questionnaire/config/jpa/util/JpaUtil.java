...
public final class JpaUtil extends JpaSearchQueryUtil {
     ...
     * @throws EntityPersistenceException if there is any error
     */
     ...
     *
     * @param <T>           the retrieved entity type
     * @param entityManager the entity manager
     ...
     *
     * @param <T>           the merged entity type
     * @param entityManager the entity manager
     ...
     * @throws EntityPersistenceException if any error occurs
     */
     ...
     *
     * @param <T>           the saved entity type
     * @param entityManager the entity manager
     * @param entity        the entity save
     ...
     *
     * @param <T>           the saved entities type
     * @param entityManager the entity manager
     * @param entities      the entities save
     ...
     *
     * @param <T>           the removed entity type
     * @param entityManager the entity manager
     * @param entityType    the removed entity type
     * @param id            the entity id
     * @throws NoEntityFoundException     if entity with the given id is not found
     * @throws EntityPersistenceException if there is any other error
     */
