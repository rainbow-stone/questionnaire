...
public abstract class BaseJpaUtil {
     ...
     *
     * @param <T>           类型
     * @param queryHints    查询Hint
     * @param entityManager {@link EntityManager}
     * @param returnedType  返回类型
     * @param jpql          JPQL语句
     ...
     * </p>
     *
     * @param baseJpql     it can be a template JPQL that contains {@link BaseJpaUtil#WHERE_CLAUSE_TOKEN} and
     *                     {@link BaseJpaUtil#ORDER_BY_CLAUSE_TOKEN}
     ...
     *
     * @param jpaFragments the array of JpaFragment
